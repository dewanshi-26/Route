...
public class BackgroundFetchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPauseService.setOnClickListener(v -> sendActionToService("com.example.bmc_dian.PAUSE"));
        btnResumeService.setOnClickListener(v -> sendActionToService("com.example.bmc_dian.RESUME"));
        ...
        // Add a long-click to Share/Export the text file
